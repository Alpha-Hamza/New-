...
export default function SecondSection() {
  return (
    <div className="relative  2xl:mt-[280px] xl:mt-[200px] mt-[200px]   ">
      ...
      <img src="./images/hi5.svg" alt=" " className="  absolute left-[10%] sm:-mt-[5%] -mt-[20%]  lg:w-auto   sm:max-w-[15%] max-w-[20%]   " />

        <h1 className="text-[#10B981] lg:text-[36px] md:text-[30px] text-[24px] mb-[80px] font-extrabold">
          Explore Dream Studio
        </h1>
        <img src="./images/hi6.svg" alt=" " className=" absolute right-[5%] sm:-mt-[5%] -mt-[20%] lg:w-auto  md:max-w-[15%] sm:max-w-[10%] max-w-[15%]    " />
      </div>
